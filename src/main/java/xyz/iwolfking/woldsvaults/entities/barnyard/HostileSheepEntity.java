package xyz.iwolfking.woldsvaults.entities.barnyard;
...
import xyz.iwolfking.woldsvaults.mixins.accessors.SheepAccessor;

public class HostileSheepEntity extends Sheep {

    public HostileSheepEntity(EntityType<? extends Sheep> pEntityType, Level pLevel) {
    ...
    public boolean isBaby() {
        return false; // Make sure they are full-sized
    }
