...
public class LoginarModel extends EntityModel<LoginarHostileAlienEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(WoldsVaults.id("loginar"), "main");
	...
	@Override
	public void setupAnim(LoginarHostileAlienEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
