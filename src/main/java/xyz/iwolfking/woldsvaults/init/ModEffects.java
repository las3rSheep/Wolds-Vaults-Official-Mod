...
import xyz.iwolfking.woldsvaults.effect.mobeffects.GroundedPotionEffect;
...
public class ModEffects {
    ...
    public static void register(RegistryEvent.Register<MobEffect> event) {
        event.getRegistry().registerAll(new MobEffect[]{SHRINKING, GROWING, REAVING,COLOSSUS,SNEAKY_GETAWAY, GROUNDED});
    }
}
