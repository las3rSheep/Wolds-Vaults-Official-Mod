...
//
//    @Nullable
//    public VaultAmuletConfig.Charm getCharmConfig(CharmEffect<?> charmEffect) {
...
//
//    @Nullable
//    public VaultAmuletEffect<?> getRandomTrinketSet(BiFunction<CharmEffect<?>, Integer, Integer> weightAdjustFn, VaultAmuletConfig.Size size) {
...
////            if (charmEffect instanceof AttributeCharm<?> attributeCharm) {
...
//
//        });
//        return (VaultAmuletEffect)list.getRandom().orElse((VaultAmuletEffect<?>) null);
//    }
//
...
//        this.CHARMS.clear();
//        Iterator var1 = CharmEffectRegistry.getOrderedEntries().iterator();
//
//        while(var1.hasNext()) {
//            CharmEffect<?> effect = (CharmEffect)var1.next();
