...
public class MixinSoulboundSnapshot {
    ...
    protected boolean shouldSnapshotItem(Player player, ItemStack stack) {
        return !stack.isEmpty() && (((Boolean) AttributeGearData.read(stack).get(ModGearAttributes.SOULBOUND, VaultGearAttributeTypeMerger.anyTrue()) || stack.getItem() instanceof WalletItem));
    }
}
